...
public class EmailService {
    ...
    public void sendRenewalReminder(Subscription subscription) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(subscription.getUsers().get(0).getEmail());
        message.setSubject("Renewal Reminder for Your Subscription");
        message.setText("Your subscription will expire soon. Please renew to continue enjoying our services.");
        mailSender.send(message);
    }
}